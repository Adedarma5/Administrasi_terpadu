...
const PembelajaranMataKuliah = () => {
    ...
    const fetchPembelajaranMataKuliah = async () => {
        try {
            ...
            const response = await axios.get("http://localhost:5000/pembelajaran_mata_kuliah", {
                headers: {
    ...
    const fetchBahanAjarByPembelajaran = async (pembelajaranId) => {
        try {
            const response = await axios.get(`http://localhost:5000/bahan_ajar`);
            const filtered = response.data.filter(item => item.pembelajaran_id === pembelajaranId);
    ...
    const handleShowDetail = async (item) => {
        ...
        await fetchBahanAjarByPembelajaran(item.id);
    ...
    return (
        <Container fluid className="p-4">
            <Row className="align-items-center p-4">
                ...
                <Col xs="auto">
                    <Button variant="success" className="d-flex align-items-center gap-2" onClick={() => navigate("/admin/dashboard/PembelajaranMataKuliah/TambahPembelajaranMataKuliah")}> <FiPlus size={18} /> <span>Tambah</span></Button>
                </Col>
            </Row>
                    ...
                    <Row>
                        {paginated.map((item, index) => (
                            <Col lg={4} md={6} key={item.id} className="mb-4">
                                <Card className="h-100 shadow border-0 course-card small" style={{
                                    ...
                                    <Card.Body className="p-4 ">
                                        <div className="mb-4">
                                            ...
                                            <div className="mb-2">
                                                ...
                                                <h5 className="mb-0 fw-bold text-success" style={{ lineHeight: '1.3' }}>
                                                    {item.mata_kuliah}
                                                </h5>
                                            </div>
                                        ...
                                        <div className="border-top pt-2">
                                            ...
                                            <div className="d-flex flex-column gap-2">
                                                ...
                                                <Button
                                                    ...
                                                    size="sm"
                                                    className="d-flex align-items-center justify-content-start text-start border-0 "
                                                    onClick={() => navigate(`/admin/dashboard/bahanajar/tambahbahanajar/${item.id}`)}
                                                    style={{
                                                        borderRadius: '8px',
                                                        transition: 'all 0.2s ease'
                                                    }}
                                                >
                                                    ...
                                                    <span>lihat / Tambah Bahan Ajar</span>
